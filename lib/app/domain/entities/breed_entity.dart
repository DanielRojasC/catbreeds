import 'package:catbreeds/app/domain/entities/image_entity.dart';
import 'package:catbreeds/app/domain/entities/weight_entity.dart';
  ...
  factory BreedEntity.fromJson(Map<String, dynamic> json) {
    return BreedEntity(
      ...
      image: json['image'] != null
          ? ImageEntity.fromJson(json['image'])
          : ImageEntity(id: "", width: 0, height: 0, url: ""),
    );
  }
